...
if not exist "%~dp0..\artifacts\build\portable-win8+net45+wp8" mkdir "%~dp0..\artifacts\build\portable-win8+net45+wp8"
...
copy "%~dp0..\src\ReferenceGenerator\NuSpec.ReferenceGenerator.targets" "%~dp0..\artifacts\build\portable-win8+net45+wp8\NuSpec.ReferenceGenerator.targets" /y